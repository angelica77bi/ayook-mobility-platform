...
Pricing is tiered by rental duration. If the selected days fall between tiers, the price is calculated using the average daily rate of the highest tier that does not exceed the rental days, multiplied by the total days.

Example for Vision 1:
...
If a user selects 4 days, it uses the 3-day tier average: `430 / 3 * 4`.

Example for Vision Pro:
